  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        IconButton(
          onPressed: onPressed,
          icon: Icon(icon, size: 25, color: selected ? CoinbaseTheme.color : Colors.black.withOpacity(.75)),
        ),
        Text(
          text,
          style: TextStyle(fontSize: 12, height: .1, color: selected ? CoinbaseTheme.color : Colors.black.withOpacity(.75)),
        )
      ],
    );
  }
